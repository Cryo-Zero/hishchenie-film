(() => {
  ...
  const I18N = {
    ru: {
      ...
      heroPosterAlt: 'Официальная обложка фильма «Хищение»',
      ...
      genreValue: 'Антиутопия · Драма · Боевик · Приключения · Фантастика', statusValue: 'В разработке',
      ...
      close: 'Закрыть', previousImage: 'Предыдущее изображение', nextImage: 'Следующее изображение', galleryAria: 'Галерея материалов фильма', lightboxAria: 'Просмотр изображения',
      langButton: 'EN',
    ...
    en: {
      ...
      heroPosterAlt: 'Official poster for THEFT / ХИЩЕНИЕ',
      ...
      genreValue: 'Dystopia · Drama · Action · Adventure · Science Fiction', statusValue: 'In development',
      ...
      close: 'Close', previousImage: 'Previous image', nextImage: 'Next image', galleryAria: 'Film materials gallery', lightboxAria: 'Image viewer',
      langButton: 'RU',
