(() => {
  ...
  const CLIENT_REVISION = 'P21-true-designer';
  ...
  const I18N = {
    ru: {
      ...
      oldSort: 'Старые', popular: 'Популярные', withOfficialResponse: 'С ответом команды', allReviews: 'Все отзывы', useful: 'Полезно', replies: 'Ответы', reply: 'Ответить', replyPlaceholder: 'Короткий ответ на отзыв…', replySave: 'Отправить', replyDelete: 'Удалить ответ', replyEmpty: 'Ответов пока нет.', replySaved: 'Ответ сохранён.', replyError: 'Не удалось сохранить ответ.', pinned: 'закреплено', official: 'СИСТЕМНЫЙ КАНАЛ · OFFICIAL',
      ...
      faqQ2: 'Где можно посмотреть фильм?', faqA2: 'Площадки появятся в разделе «Где посмотреть» после подтверждения релиза.', faqStatus2: 'ОЖИДАНИЕ РЕЛИЗА', faqMessage2: 'СПИСОК ПЛОЩАДОК ПУБЛИКУЕТСЯ ПОСЛЕ ПОДТВЕРЖДЕНИЯ',
    ...
    en: {
      ...
      faqQ2: 'Where can I watch the film?', faqA2: 'Platforms will appear in the Watch section after the release is confirmed.', faqStatus2: 'AWAITING RELEASE', faqMessage2: 'PLATFORM LIST IS PUBLISHED AFTER CONFIRMATION',
      faqQ3: 'Will the film be shown in cinemas?', faqA3: 'Requires clarification.', faqStatus3: 'REQUIRES CLARIFICATION', faqMessage3: 'CINEMA DISTRIBUTION IS BEING CLARIFIED',
      ...
      faqQ5: 'What is THEFT about?', faqA5: 'The story takes place in 2045 inside a system where a person must prove their usefulness to society. See the About section for more.', faqStatus5: 'DOSSIER OPEN', faqMessage5: 'BASIC INFORMATION IS AVAILABLE IN THE ABOUT SECTION',
      faqQ6: 'When will new materials appear?', faqA6: 'New materials are published after approval from the filmmaker and preparation for publication.', faqStatus6: 'AWAITING UPDATE', faqMessage6: 'NEW MATERIALS ARE PUBLISHED AFTER CONFIRMATION',
      faqQ7: 'Who is working on the film?', faqA7: 'Confirmed director and cast names are published on this website. The list can expand as new material is confirmed.', faqStatus7: 'CONFIRMED DATA', faqMessage7: 'THE TEAM LIST UPDATES AS DATA IS CONFIRMED',
      faqQ8: 'Is this website secure?', faqA8: 'The system allows users to use a technical identifier without linking personal data for profile and review functions.', faqStatus8: 'PROTOCOL ACTIVE', faqMessage8: 'MINIMUM DATA // LOCAL PROFILE BINDING',
